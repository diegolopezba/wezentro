      ...
      <div className="px-4 py-2">
        <div className="divide-y divide-background">
          ...
          return <motion.button key={item.label} initial={{
            ...
            delay: index * 0.05
          }} onClick={() => navigate(item.path)} className="w-full flex items-center gap-4 py-4 hover:bg-secondary/30 px-4 transition-colors mx-0">
        ...
        delay: 0.3
      }} onClick={handleSignOut} className="w-full flex items-center gap-4 py-4 mt-8 hover:bg-destructive/10 -mx-4 px-4 transition-colors">
