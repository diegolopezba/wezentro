      ...
      <div className="relative -mt-16 px-4 pb-8">
        ...
        y: 0
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex items-center gap-3 p-4 rounded-2xl py-[6px] pl-0 pr-px bg-primary-foreground">
          ...
          <div className="flex items-center gap-3 p-4 rounded-2xl py-[6px] pl-0 bg-primary-foreground">
            <div className="w-10 h-10 rounded-xl flex items-center justify-center bg-primary-foreground">
