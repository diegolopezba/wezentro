...
const Discover = () => {
  ...
  return <AppLayout>
      ...
      <div className="relative h-[calc(100vh-80px)] bg-secondary">
        ...
        {/* Map content */}
        <div className="absolute inset-0 flex items-center justify-center" onClick={handleCloseEventCard}>
        ...
        delay: index * 0.1
      }} className="absolute cursor-pointer z-10" style={{
        top: `${30 + index * 15}%`,
        left: `${20 + index * 25}%`
      }} onClick={e => {
        e.stopPropagation();
        ...
        <AnimatePresence>
          ...
          damping: 25,
          stiffness: 300
        }} className="absolute bottom-4 left-4 right-4 z-50" onClick={e => e.stopPropagation()}>
              <div className="relative">
