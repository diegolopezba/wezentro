    ...
    <AppLayout>
      ...
      <header className="sticky top-0 z-40 safe-top">
        <div className="flex items-center justify-between px-4 py-0 bg-background">
          <h1 className="font-brand text-xl font-bold text-foreground">@{profile?.username || "loading"}</h1>
      ...
      <div className="px-4 py-[10px] bg-background">
        ...
        {!isPremium && (
          <motion.div
            ...
            className="mt-4"
          >
            <div className="p-4 rounded-2xl border bg-gradient-to-r from-amber-500/20 to-gold-500/20 border-amber-500/30">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Upgrade to join guestlists</p>
                  </div>
                </div>
          ...
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-2 py-4 transition-colors relative ${isActive ? "text-primary" : "text-muted-foreground"}`}
              >
