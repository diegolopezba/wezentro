...
const mockUsers: Record<string, { name: string; username: string; avatar: string }> = {
  "user-1": {
    name: "Alex Martinez",
...
const mockMessages = [
  ...
  { id: "2", text: "Yes! Can't wait 🎉", sender: "me", time: "10:32 AM" },
  { id: "3", text: "Should be amazing, the DJ lineup looks incredible", sender: "them", time: "10:33 AM" },
  { id: "4", text: "Right? See you there!", sender: "me", time: "10:35 AM" },
];
