...
const es: LandingCopy = {
  nav: {
    ...
    exitPresent: "Salir",
    cta: "Crear evento",
    ctaEvents: "Crear evento",
    ctaRestaurants: "Crear restaurante",
    ctaExperiences: "Crear experiencia",
    demo: "Agendar demo",
    slide: "Diapositiva",
  },
  hero: {
...
const en: LandingCopy = {
  nav: {
    ...
    ctaEvents: "Create event",
    ctaRestaurants: "Create restaurant",
    ctaExperiences: "Create experience",
    demo: "Book a demo",
    slide: "Slide",
  },
  hero: {
